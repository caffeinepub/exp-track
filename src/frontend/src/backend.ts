...
import type { Expense as _Expense, ExternalBlob as _ExternalBlob, OCRResponse as _OCRResponse, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addParticipantToOccasion(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addParticipantToOccasion(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createExpense(arg0: Expense): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createExpense(await to_candid_Expense_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOccasion(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createOccasion(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async extractAmountFromImage(arg0: OCRParams): Promise<OCRResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.extractAmountFromImage(arg0);
                return from_candid_OCRResponse_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getAggregateTotals(): Promise<Array<[string, number]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAggregateTotals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllOccasions(): Promise<Array<Occasion>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllOccasions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getExpensesByOccasion(arg0: string): Promise<Array<Expense>> {
        if (this.processError) {
            try {
                const result = await this.actor.getExpensesByOccasion(arg0);
                return from_candid_vec_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getExpensesByUser(arg0: Principal): Promise<Array<Expense>> {
        if (this.processError) {
            try {
                const result = await this.actor.getExpensesByUser(arg0);
                return from_candid_vec_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadImage(arg0: ExternalBlob): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadImage(await to_candid_ExternalBlob_n12(this._uploadFile, this._downloadFile, arg0));
...
async function from_candid_Expense_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Expense): Promise<Expense> {
...
function from_candid_OCRResponse_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OCRResponse): OCRResponse {
...
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        occasionId: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.occasionId)),
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Expense>): Promise<Array<Expense>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Expense_n17(_uploadFile, _downloadFile, x)));
}
async function to_candid_Expense_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Expense): Promise<_Expense> {
...
async function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        date: value.date,
        description: value.description,
        occasionId: value.occasionId ? candid_some(value.occasionId) : candid_none(),
